...
<img src="./readme/qrcode1.png" width = "200" height = "200" alt="梅花行踪菊花码" />
...
期望：关于页出现梅花行踪的友情链接、科普的二级页面出现文字信息，则说明创建成功。
...
本项目遵循MPL-2.0开源协议。在此基础上，如果你发布了一份新的猫谱，我们希望你能保留梅花行踪的友情链接。待你的线上版本稳定使用一段时间后，请留言告诉我们将你的友链加到梅花行踪小程序中。
